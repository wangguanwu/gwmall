...
public class StockManageController {
    ...
    public CommonResult<Boolean> descStock(@RequestParam Long productId, Long skuId, Integer quanlity, Integer miaosha){
    ...
    */
    ...
    CommonResult<Integer> reduceStock(@RequestBody List<StockChanges> stockChangesList){
        return stockManageService.reduceStock(stockChangesList);
    }

    @RequestMapping("/recoverStock")
    CommonResult<Boolean> recoverStock(@RequestBody List<StockChanges> stockChangesList){
