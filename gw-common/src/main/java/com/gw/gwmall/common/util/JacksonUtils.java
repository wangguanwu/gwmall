...
/**
 * @author guanwu
 * @created on 2023-02-15 19:31:05
 *
 * 从Nacos复制，并改造
 **/
/*
...
import com.gw.gwmall.common.exception.GwDeserializationException;
import com.gw.gwmall.common.exception.GwSerializationException;
...
public final class JacksonUtils {
     ...
     * @param obj obj
     * @return json string
     * @throws GwSerializationException if transfer failed
     */
    public static String toJson(Object obj) {
        try {
            ...
            throw new GwSerializationException(obj.getClass(), e);
        }
    }
     ...
     * @return object
     * @throws GwSerializationException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            return toObj(StringUtils.newStringForUtf8(json), cls);
        } catch (Exception e) {
            throw new GwSerializationException(cls, e);
        }
    }
     ...
     * @param <T>  General type
     * @return object
     * @throws GwDeserializationException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Type cls) {
        try {
            return toObj(StringUtils.newStringForUtf8(json), cls);
        } catch (Exception e) {
            throw new GwDeserializationException(e);
        }
    }
    ...
    public static <T> T toObj(String json, Class<T> cls) {
        try {
            ...
            throw new GwDeserializationException(cls, e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new GwDeserializationException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new GwDeserializationException(type, e);
        }
    }
