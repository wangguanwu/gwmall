...
import com.gw.gwmall.cart.component.rocketmq.OrderMessageSender;
import com.gw.gwmall.cart.dao.MiaoShaStockDao;
...
import com.gw.gwmall.cart.feignapi.pms.PmsProductFeignApi;
import com.gw.gwmall.cart.feignapi.ums.UmsMemberFeignApi;
import com.gw.gwmall.cart.mapper.OmsOrderItemMapper;
import com.gw.gwmall.cart.mapper.OmsOrderMapper;
...
//    private String REDIS_KEY_PREFIX_ORDER_ID;
     ...
     */
    @Override
    public CommonResult<ConfirmOrderResult> generateConfirmMiaoShaOrder(Long productId
            , Long memberId, String token) throws BusinessException {
        //【1】 进行订单金额确认前的库存与购买权限检查
        CommonResult<ConfirmOrderResult> commonResult = (CommonResult<ConfirmOrderResult>) confirmCheck(productId,memberId,token);
